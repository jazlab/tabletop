...
class NatNetClient:
    ...
    def __init__(self):
        ...
        self.keep_alive_interval = 2.0
        self.print_level = 120 * 2
    ...
    def get_message_id(self, data: bytes) -> MessageID:
        message_id = int.from_bytes(data[0:2], byteorder="little", signed=True)
        return MessageID(message_id)

    def connected(self):
        # check versions
        if self.get_application_name() == "Not Set":
            return False
        if (
    ...
    def __create_command_socket(self):
        ...
        result.settimeout(self.socket_timeout)
        print(f"Command socket address: {result.getsockname()}")
        return result

    # Create a data socket to attach to the NatNet stream
    def __create_data_socket(self) -> socket.socket:
        if self.use_multicast:
            # Multicast case
            result = socket.socket(
        ...
        result.settimeout(self.socket_timeout)
        print(f"Data socket address: {result.getsockname()}")
        return result
    ...
    def __unpack_rigid_body(self, data, major, minor, rb_num):
        if major >= 3:
            offset, rigid_body = self.__unpack_rigid_body_3_and_above(
                data, rb_num
            )  # type: ignore  # noqa E501
        elif major == 2 and minor >= 6:
            offset, rigid_body = self.__unpack_rigid_body_2_6_to_3(
                data, rb_num
            )  # type: ignore  # noqa E501
        elif major < 2 or (major == 2 and minor < 6):
            offset, rigid_body = self.__unpack_rigid_body_pre_2_6(
                data, major, rb_num
            )  # type: ignore  # noqa E501
        elif major == 0:
    ...
    def __unpack_marker_set_data(self, data, packet_size, major, minor):
        ...
        for i in range(0, marker_set_count):
            ...
            # Model name
            model_name, separator, remainder = bytes(data[offset:]).partition(
                b"\0"
            )  # type: ignore  # noqa E501
            ...
            for i in range(0, force_plate_count):
                ...
                for j in range(force_plate_channel_count):
                    ...
                    for k in range(force_plate_channel_frame_count):
                        ...
                        offset += 4
                        fp_channel_data.add_frame_entry(
                            force_plate_channel_val
                        )  # type: ignore  # noqa E501
        ...
        if (major == 2 and minor >= 11) or (major > 2):
            ...
            for i in range(0, device_count):
                ...
                for j in range(0, device_channel_count):
                    ...
                    # Device Frame Data
                    n_frames_show = min(
                        device_channel_frame_count, n_frames_show_max
                    )  # type: ignore  # noqa E501
    ...
    def __unpack_frame_suffix_data_4_1_to_present(
        self, data, offset, frame_suffix_data, param
    ):  # type: ignore  # noqa E501
        ...
        if (packet_size - offset) <= 0:
            ...
            if major == 0:
                data, offset, frame_suffix_data, param = (
                    self.__unpack_frame_suffix_data_0_case(
                        data, offset, frame_suffix_data, param
                    )
                )  # type: ignore  # noqa E501
            elif major < 2 or (major <= 2 and minor < 7):
                data, offset, frame_suffix_data, param = (
                    self.__unpack_frame_suffix_data_pre_2_7(
                        data, offset, frame_suffix_data, param
                    )
                )  # type: ignore  # noqa E501
            elif major == 2 and minor >= 7 and major < 3:
                data, offset, frame_suffix_data, param = (
                    self.__unpack_frame_suffix_data_2_7_to_3(
                        data, offset, frame_suffix_data, param
                    )
                )  # type: ignore  # noqa E501
            elif major >= 3 or (major == 4 and minor == 0):
                data, offset, frame_suffix_data, param = (
                    self.__unpack_frame_suffix_data_3_to_4(
                        data, offset, frame_suffix_data, param
                    )
                )  # type: ignore  # noqa E501
    ...
    def __unpack_mocap_data(self, data: bytes, packet_size, major, minor):
        ...
        rel_offset = 0
        # Frame Prefix Data
        rel_offset, frame_prefix_data = self.__unpack_frame_prefix_data(
            data[offset:]
        )  # type: ignore  # noqa E501
        offset += rel_offset
        ...
        legacy_other_markers_count = (
            marker_set_data.get_unlabeled_marker_count()
    ...
    def __unpack_marker_set_description(self, data, major, minor):
        ...
        if marker_count > 0:
            for i in range(0, marker_count):
                name, separator, remainder = bytes(data[offset:]).partition(
                    b"\0"
                )  # type: ignore  # noqa E501
                offset += len(name) + 1
    ...
    def __unpack_rigid_body_descript_4_2_to_current(self, data):
        ...
        for marker in marker_count_range:
            ...
            marker_name, separator, remainder = bytes(
                data[offset3:]
            ).partition(b"\0")  # type: ignore  # noqa E501
            ...
            trace_dd(
                ...
                % (
                    marker,
                    active_label,  # type: ignore  # noqa E501
    ...
    def __unpack_rigid_body_description(self, data, major, minor):
        if major == 0:
            ...
            offset, rb_desc = self.__unpack_rigid_body_descript_4_2_to_current(
                data
            )  # type: ignore  # noqa E501
        elif major == 4:
    ...
    def __unpack_force_plate_description(self, data, major, minor):
        ...
        if major >= 3:
            ...
            # Serial Number
            serial_number, separator, remainder = bytes(
                data[offset:]
            ).partition(b"\0")  # type: ignore  # noqa F401
            ...
            for i in range(0, 12):
                cal_matrix_row = FPCalMatrixRow.unpack(
                    data[offset : offset + (12 * 4)]
                )  # type: ignore  # noqa E501
                trace_dd(
                    "\t%3.1d %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e %3.3e"
                    % (
                        i,  # type: ignore  # noqa E501
                        cal_matrix_row[0],
                        cal_matrix_row[1],
                        cal_matrix_row[2],
                        cal_matrix_row[3],  # type: ignore  # noqa E501
                        cal_matrix_row[4],
                        cal_matrix_row[5],
                        cal_matrix_row[6],
                        cal_matrix_row[7],  # type: ignore  # noqa E501
                        cal_matrix_row[8],
                        cal_matrix_row[9],
                        cal_matrix_row[10],
                        cal_matrix_row[11],
                ...
                cal_matrix_tmp[i] = list(cal_matrix_row)
                offset += 12 * 4
            ...
            for i in range(0, num_channels):
                channel_name, separator, remainder = bytes(
                    data[offset:]
                ).partition(b"\0")  # type: ignore  # noqa E501
                offset += len(channel_name) + 1
                trace_dd(
                    "\tChannel Name %3.1d: %s"
                    % (i, channel_name.decode("utf-8"))
                )  # type: ignore  # noqa E501
    ...
    def __unpack_device_description(self, data, major, minor):
        ...
        if major >= 3:
            ...
            for i in range(0, num_channels):
                ...
                trace_dd(
                    "\tChannel ", i, " Name: ", channel_name.decode("utf-8")
                )  # type: ignore  # noqa E501
    ...
    def __unpack_camera_description(self, data, major, minor):
        ...
        camera_desc = DataDescriptions.CameraDescription(
    ...
    def __unpack_data_descriptions(
        self, data: bytes, packet_size, major, minor
    ):  # type: ignore  # noqa E501
        ...
        for i in range(0, dataset_count):
            ...
            trace_dd(
                "\t " + str(offset) + " bytes processed of " + str(packet_size)
            )  # type: ignore  # noqa E501
    ...
    def __socket_thread_function(self, in_socket: socket.socket, port: int):
        try:
            self.send_request(
                in_socket,
                MessageID.NAT_CONNECT,
                "",
                (self.server_ip_address, port),
            )
            ...
            buffer_list_size = 4
            buffer_list = [bytes() for _ in range(buffer_list_size)]
            buffer_list_recv_index = 0
            last_keep_alive_time = time.time()
            while not self.stop_event.is_set():
                # Send keep alive if not using multicast
                current_time = time.time()
                if not self.use_multicast and (
                    current_time - last_keep_alive_time
                    > self.keep_alive_interval
                ):
                    self.send_keep_alive(
                        in_socket, self.server_ip_address, port
                    )
                ...
                try:
                    ...
                    print(
                        f"ERROR: socket {in_socket.getsockname()} access timeout occurred: {e}"
                    )
                    continue
                except socket.error:
                ...
                if len(data) > 0:
                    ...
                    buffer_list[buffer_list_recv_index] = data
                    buffer_list_recv_index = (
                        buffer_list_recv_index + 1
                    ) % buffer_list_size
                    ...
                    if message_id == MessageID.NAT_FRAMEOFDATA:
                        if print_level > 0:
                    ...
                    if print_level > 0:
                        print(
                            f"Socket {in_socket.getsockname()} received message from {addr}"
                        )
        finally:
    ...
    def __data_thread_function(self, in_socket):
        ...
        while not self.stop_event.is_set():
            data = bytes()
            try:
                data, _ = in_socket.recvfrom(recv_buffer_size)
            except socket.timeout as e:
                print(f"Data socket access timeout occurred: {e}")
                continue
            except socket.error:
                if not self.stop_event.is_set():
                    raise
            ...
            if len(data) > 0:
                print(f"Received data on data socket: {data}")
                # peek ahead at message_id
                message_id = self.get_message_id(data)
                tmp_str = "mi_%1.1d" % message_id
                if tmp_str not in message_id_dict:
            ...
            if not self.use_multicast:
                if not self.stop_event.is_set():
                    self.send_keep_alive(
                        in_socket, self.server_ip_address, self.data_port
                    )
    ...
    def __process_message(self, data: bytes, print_level=0):
        ...
        if message_id == MessageID.NAT_FRAMEOFDATA:
            ...
            if print_level >= 1:
                assert mocap_data.prefix_data is not None
                print(
        ...
        elif message_id == MessageID.NAT_MODELDEF:
        ...
        elif message_id == MessageID.NAT_SERVERINFO:
        ...
        elif message_id == MessageID.NAT_RESPONSE:
            ...
            if packet_size == 4:
                ...
                message, separator, remainder = bytes(data[offset:]).partition(
                    b"\0"
                )  # type: ignore  # noqa E501
                if len(message) < 30:
    ...
    def send_request(self, in_socket, command, command_str, address):
        ...
        packet_size = 0
        if (
            command == MessageID.NAT_REQUEST_MODELDEF
            or command == MessageID.NAT_REQUEST_FRAMEOFDATA
        ):  # type: ignore  # noqa E501
            packet_size = 0
            command_str = ""
        elif command == MessageID.NAT_REQUEST:
            packet_size = len(command_str) + 1
        elif command == MessageID.NAT_CONNECT:
            tmp_version = [4, 2, 0, 0]
            # print(
            ...
            packet_size = len(command_str) + 1
        elif command == MessageID.NAT_KEEPALIVE:
            packet_size = 0
            command_str = ""
        ...
        if command == MessageID.NAT_CONNECT:
            assert isinstance(command_str, list)
            data += bytes(command_str)
        else:
    ...
    def run(self):
        if self.is_shutdown:
            raise RuntimeError(
                "Client is already shutdown, create a new client to reconnect"
            )
        ...
        # Initialize the event and lock
        self.__is_locked = True
        self.stop_event.clear()

        # Create the threads
        # self.data_thread = self.tpe.submit(
        #     self.__socket_thread_function,
        #     self.data_socket,
        #     self.data_port,
        # )

        self.command_future = self.tpe.submit(
            self.__socket_thread_function,
            self.command_socket,
            self.command_port,
        )
    ...
    def shutdown(self):
        ...
        with self.shutdown_lock:
            if (
                not hasattr(self, "command_socket")
                or not hasattr(self, "command_future")
                or self.is_shutdown
            ):
                return
            ...
            try:
                self.command_future.result()
            except Exception as e:
                print(f"Error in command thread: {type(e).__name__}: {e}")
            # try:
            #     self.data_thread.result()
            # except Exception as e:
            #     print(f"Error in data thread: {type(e).__name__}: {e}")
