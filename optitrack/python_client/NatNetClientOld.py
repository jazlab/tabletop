...
class NatNetClient:
    ...
    def __command_thread_function(
        self, in_socket, stop, gprint_level, thread_option
    ):  # type: ignore  # noqa E501
        message_id_dict = {}
        ...
        buffer_list_size = 4
        buffer_list = [
            bytearray(recv_buffer_size) for _ in range(buffer_list_size)
        ]  # type: ignore  # noqa E501
        ...
        while not stop():
            # Block for input
            try:
                buffer_list[buffer_list_recv_index], addr = in_socket.recvfrom(
                    recv_buffer_size
                )  # type: ignore  # noqa E501
                buffer_list_in_use_index = buffer_list_recv_index
                buffer_list_recv_index = (
                    buffer_list_recv_index + 1
                ) % buffer_list_size  # type: ignore  # noqa E501
    ...
    def __data_thread_function(self, in_socket, stop, gprint_level):
        ...
        while not stop():
            ...
            try:
                ...
                if not stop():
                    print(
                        "ERROR: data socket access error occurred:\n  %s" % msg
                    )  # type: ignore  # noqa E501
                    return 1
            except socket.herror:
