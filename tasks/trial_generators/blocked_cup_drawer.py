...
from trial_generators import base_trial_generator
import numpy as np


class BlockedCupDrawer(base_trial_generator.BaseTrialGenerator):
    ...
    def __call__(self) -> base_trial_generator.TrialSpec:
        ...
        # Make trial spec
        trial_spec = base_trial_generator.TrialSpec(
            object_id=object_id,
