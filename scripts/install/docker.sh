...
print_status "Removing old Docker packages if they exist..."
...
print_status "Creating docker group and adding current user ($USER) to it..."
...
print_status "Configuring Docker logging driver with log rotation..."
...
print_status "Configuring Docker to start on boot..."
